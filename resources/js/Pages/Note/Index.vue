...
const importFile = async (event) => {
    ...
    reader.onload = (e) => {
        easyMDE.value(e.target.result); // Memasukkan konten ke editor
        localStorage.setItem("markdown-content", e.target.result); // Simpan ke localStorage
    };
        ...
        <div class="max-w-4xl mx-auto mt-10 mb-10 p-6 bg-gray-100 dark:bg-gray-800 rounded-lg shadow-lg">
            ...
            <div class="mt-3 flex flex-wrap items-center gap-4">
                ...
                <div class="mt-4 flex space-x-2">
                    <input type="file" accept=".md" @change="importFile"
